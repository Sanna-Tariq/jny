...
<template>
  <div>
    <div v-if="isMobileMenuOpen"
      ...
      <div class="space-y-1">
        <BaseButton v-for="(navlink, index) in navlinks" :key="index" :to="navlink.link"
          :variant="isCurrentRoute(navlink, currentPath) ? 'solid' : 'ghost'" block class=" whitespace-nowrap" size="md"
