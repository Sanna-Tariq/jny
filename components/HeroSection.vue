...
<template>
  <section class="container mx-auto pb-12 px-4">
    <div class="bg-center bg-banner bg-cover bg-no-repeat blur-none rounded-3xl z-0">
      <!-- <div
          ...
          <div class="-mx-4 flex flex-wrap items-center mt-24 space-y-6 lg:space-y-0">
            <div class="px-4 w-full md:w-8/12 xl:w-6/12">
              ...
              <p class="font-thin mb-6 text-gray-300 hidden md:block">
                Welcome to JNY Enterprises, your premier destination for high-quality disposable items. From cups to
                cutlery, we offer a wide range of convenient solutions to meet your needs. With a commitment to quality
                and sustainability, we strive to make every disposable experience exceptional. Explore our collection and
