...
const callToActions = [
  ...
  {
    img: '/deal/coke.webp',
    action: 'Disposable Glasses',
    to: '/glasses',
  },
  {
    img: '/deal/plate.webp',
    action: 'Plastic Plate Cutlery',
    to: '/plate',
  },
]
</script>
  ...
  <section class="container mx-auto px-4 py-12">
    <div>
      ...
      <p class="mt-4 text-justify md:text-center">
        ...
        deliver innovative solutions that enhance everyday experiences while minimizing environmental impact
      </p>
    </div>
